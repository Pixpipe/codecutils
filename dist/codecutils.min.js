...
d+c>a.byteLength)console.warn("The requested number of elements is too large for this buffer");else return a=a.slice(c,c+d*b.BYTES_PER_ELEMENT),new b(a)};e.prototype.getTypedArrayInfo=function(a){var c=null,b=!1;a instanceof Int8Array?(c="int",b=!1):a instanceof Uint8Array?(c="int",b=!0):a instanceof Uint8ClampedArray?(c="int",b=!0):a instanceof Int16Array?(c="int",b=!1):a instanceof Uint16Array?(c="int",b=!0):a instanceof Int32Array?(c="int",b=!1):a instanceof Uint32Array?(c="int",b=!0):a instanceof
Float32Array?(c="float",b=!1):a instanceof Float64Array&&(c="float",b=!1);return{type:c,signed:b,bytesPerElements:a.BYTES_PER_ELEMENT,byteLength:a.byteLength,length:a.length}};f.CodecUtils=e;Object.defineProperty(f,"__esModule",{value:!0})});
